...
class WaveFormsADS:
    ...
    def analog_in_get_buffer_info(self) -> int:
        """Get the max buffer size of the connected device."""
        buf_max = ctypes.c_int(0)
        self._check(
            self._dwf.FDwfAnalogInBufferSizeInfo(self._hdwf, 0, ctypes.byref(buf_max)),
            "FDwfAnalogInBufferSizeInfo"
        )
        return buf_max.value
